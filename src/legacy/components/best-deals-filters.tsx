...
import type { BestDealsSort } from "@/app/actions";
...
const SORT_OPTIONS: { value: BestDealsSort; label: string }[] = [
...
export function BestDealsFilters() {
  ...
  const sort = (searchParams.get("sort") as BestDealsSort) ?? "recommended";
  ...
  const hasFilters =
    category || minPriceParam || maxPriceParam || minScoreParam || maxScoreParam;
